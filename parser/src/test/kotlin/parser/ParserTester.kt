...
//        val parser = parser.syntactic.SyntacticParser(tokens)
...
//        val lexer = Lexer
//        val syntaxParser = parser.syntactic.SyntacticParser(tokens = Lexer.lex("let x : Number = 3; x = 4;"))
//
...
//        val result = parser.syntactic.SyntacticParser(tokens).parse()
//
//        // Assert
//        val children = result.getChildren()
